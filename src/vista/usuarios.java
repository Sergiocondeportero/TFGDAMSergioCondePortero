...
public class usuarios extends javax.swing.JPanel {
    UsuariosModelo u = new UsuariosModelo();
    ...
    private void listarUsuarios() {
        List<UsuariosModelo> lista = dao.Listar();
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            ob[3] = lista.get(i).getDocumentos();
    ...
    private void initComponents() {
        ...
        cmbTipoUsuario.setModel(
                new javax.swing.DefaultComboBoxModel<>(new String[] { "Administrador", "Vendedor", "Almacenero" }));
                                ...
                                .addGroup(jpanelRound1Layout
                                        ...
                                        .addGroup(jpanelRound1Layout
                                                ...
                                                .addGroup(jpanelRound1Layout
                                                        ...
                                                        .addComponent(txtapellido, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                246, Short.MAX_VALUE)))
                                        .addComponent(jLabel10)
                                        .addComponent(cmbTipoUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, 246,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jpanelRound1Layout.setVerticalGroup(
                jpanelRound1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jpanelRound1Layout.createSequentialGroup()
                                ...
                                .addComponent(txtidusuarios, javax.swing.GroupLayout.PREFERRED_SIZE,
                                ...
                                .addComponent(jLabel10)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(cmbTipoUsuario, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(13, 13, 13)
                                .addComponent(jLabel11)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        tablaUsuarios.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[] {
                        "ID", "Nombre", "Apellido", "Docuento", "Direccion", "Telefono", "Correo", "TipoUser",
                        "Usuario", "Password"
                }));
        ...
        jpanelRound2Layout.setVerticalGroup(
                jpanelRound2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jpanelRound2Layout.createSequentialGroup()
                                .addGap(23, 23, 23)
                                .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 523,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
                        ...
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addGroup(layout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        .addComponent(jpanelRound1,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(jpanelRound2,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(btnGuardar, javax.swing.GroupLayout.PREFERRED_SIZE,
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnGuardarActionPerformed
        ...
        u.setDocumentos(txtdocumento.getText());
        ...
        if (dao.insertar(u.getNombre(), u.getApellidos(), u.getDocumentos(), u.getDireccion(),
                u.getTelefono(), u.getCorreo(), u.getTipoUsuario(), u.getUsuario(), u.getPassword())) {
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (fila == -1 && txtidusuarios.getText().isEmpty()) {
            ...
            u.setUsuario(txtusuario.getText());
            u.setPassword(txtpass.getText());
            if (dao.editar(u.getNombre(), u.getApellidos(), u.getDocumentos(), u.getDireccion(), u.getTelefono(),
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (!txtidusuarios.getText().isEmpty()) {
            int confirmacion = JOptionPane.showConfirmDialog(null, "¿Es tas seguro de eliminar el Usuario?",
                    "Confirmar", 2);
            if (confirmacion == 0) {
                u.setIdusuario(Integer.parseInt(txtidusuarios.getText()));
                dao.eliminar(u);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnBuscarActionPerformed
        ...
        if (dao.buscar(u)) {
            ...
            txtdocumento.setText(u.getDocumentos());
