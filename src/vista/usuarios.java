...
private void listarUsuarios(){
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if(fila==-1&&txtidusuarios.getText().isEmpty()){
            ...
            u.setUsuario(txtusuario.getText());
            u.setPassword(txtpass.getText());
            if(dao.editar(u.getNombre(),u.getApellidos(),u.getDocumentos(),u.getDireccion()
                ,u.getTelefono(),u.getCorreo(),u.getTipoUsuario(),u.getUsuario(),u.getPassword(),u.getIdusuario())){
                MenuPrincipal m=new MenuPrincipal();
