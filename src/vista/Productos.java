...
public class Productos extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnBuscaCategoria.setBackground(new java.awt.Color(204, 204, 255));
        btnBuscaCategoria.setBackgroundHover(new java.awt.Color(153, 153, 153));
        btnBuscaCategoria.setForegroundIcon(new java.awt.Color(0, 0, 0));
        btnBuscaCategoria.setForegroundText(new java.awt.Color(0, 0, 0));
        ...
        btnGuardar2.setBackground(new java.awt.Color(204, 204, 255));
        btnGuardar2.setText("Guardar");
        btnGuardar2.setBackgroundHover(new java.awt.Color(153, 153, 153));
        btnGuardar2.setForegroundHover(new java.awt.Color(0, 0, 0));
        btnGuardar2.setForegroundIcon(new java.awt.Color(0, 0, 0));
        btnGuardar2.setForegroundIconHover(new java.awt.Color(0, 0, 0));
        btnGuardar2.setForegroundText(new java.awt.Color(0, 0, 0));
        ...
        btnicono.setIcons(rojeru_san.efectos.ValoresEnum.ICONS.RECEIPT);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jpanelRound2, javax.swing.GroupLayout.PREFERRED_SIZE, 395, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    if (fila == -1 || txtid.getText().isEmpty()) {
        ...
        try {
            ...
            // Verificar si el campo stock está vacío antes de convertirlo
            if (txtstock.getText().isEmpty()) {
                p.setStock(0); // Si está vacío, asignamos 0 por defecto
                System.out.println("Advertencia: El campo Stock estaba vacío. Se asignó 0.");
            } else {
                p.setStock(Integer.parseInt(txtstock.getText()));
            }
            ...
            // Imprimir valores para verificar que se están enviando correctamente
            System.out.println("ID Producto: " + p.getIdproducto());
            System.out.println("Nombre: " + p.getNomProd());
            System.out.println("Stock: " + p.getStock());
            System.out.println("ID Categoría: " + p.getIdCategoria());
            System.out.println("Precio: " + p.getPrecioV());

            if (daoP.editar(p)) {
                MenuPrincipal m = new MenuPrincipal();
                m.exito("Se modificó con éxito");
                limpiarCampos();
                limpiarTablaProductos();
                listarProductos();
            } else {
                MenuPrincipal m = new MenuPrincipal();
                m.error("Error al modificar el Producto");
            }
        } catch (NumberFormatException e) {
            MenuPrincipal m = new MenuPrincipal();
            m.error("Error: Verifique los datos ingresados. Stock y Precio deben ser números.");
