...
public class DaoProductos {
    ...
    public boolean insertar(productos c){
        String SQL="insert into productos (idproducto,nombre,stock,idCategoria,precio) VALUES (?,?,?,?,?)";
        try{
            con=cn.conectar();
    ...
    public boolean editar(productos c){
        String SQL="update productos set nombre=?,stock=?,idCategoria=?,precio=? where idproducto=?";
        try{
            con=cn.conectar();
            ps=con.prepareStatement(SQL);
